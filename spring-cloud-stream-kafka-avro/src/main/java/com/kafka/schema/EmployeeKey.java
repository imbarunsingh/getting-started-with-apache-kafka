...
public class EmployeeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1826668215353915999L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeKey\",\"namespace\":\"com.kafka.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"departmentName\",\"type\":\"string\"}]}");
   ...
   */
  public static com.kafka.schema.EmployeeKey.Builder newBuilder() {
    return new com.kafka.schema.EmployeeKey.Builder();
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.kafka.schema.EmployeeKey.Builder newBuilder(com.kafka.schema.EmployeeKey.Builder other) {
    return new com.kafka.schema.EmployeeKey.Builder(other);
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.kafka.schema.EmployeeKey.Builder newBuilder(com.kafka.schema.EmployeeKey other) {
    return new com.kafka.schema.EmployeeKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.schema.EmployeeKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.schema.EmployeeKey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.schema.EmployeeKey.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.schema.EmployeeKey.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.schema.EmployeeKey.Builder setDepartmentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.schema.EmployeeKey.Builder clearDepartmentName() {
      departmentName = null;
